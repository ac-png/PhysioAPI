...
def create_exercise_session(exercise_id, user_id):
...
def seed_exercise_sessions(exercises, users):
    exercise_sessions = []
    for exercise in exercises:
        for user in users:
            session = create_exercise_session(exercise.exercise_id, user.user_id)
